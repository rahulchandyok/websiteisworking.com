  ...
  render() {
    ...
    return (
      <div className="parent-container">
        <div data-layout="row" className="header" data-layout-align="space-between">
        ...
        <main data-layout="row">
          <div className="main-content" flex="60" data-layout="column" data-layout-align="start">
            <div className="ping-container" data-layout="row" data-layout-align="start end">
              ...
              <div className="button-container">
                <button type="submit" class="button is-link is-medium" onClick={this.ping}>ping</button>
              </div>
            </div>
                ...
                <div className="result-container">
                  {this.props.home.pingResponse.errorCode === 1 &&
                    <div className="error-container">
                      ...
                      <br />
                      <label class="white-cls">It doesn't look like you entered a valid domain or service name.</label></div>}
                  {this.props.home.pingResponse.errorCode === 0 && <label>{this.props.home.pingResponse.website}
                    {this.props.home.pingResponse.working === true && <span> is working</span>}
                    {this.props.home.pingResponse.working === false && <span> is not working</span>}
                  </label>}
                </div>
          ...
          <div className="side-content" flex="40" data-layout="column" >
            <div className="history-container">
              <div className="history">
                <label className="history-label">Popular Searches</label>
                {this.props.home.recentSearches &&
                  <div className="history-list">
                    <ul> {this.props.home.recentSearches.map(val =>
                      <li className="" key={val}>{val}
                      </li>
                    )}
                    </ul>
                  </div>
            ...
            <div className="full-suite-container">
              <div className="full-suite-card" data-layout="column">
                <label className="full-suite-label">Checkout full suite of services</label>
              </div>
            </div>
          </div>
        </main>
