...
const Map = props => {
  let { results } = props
  // if (results && Object.keys(results).length === 0) return <div></div>
  return (
    <svg width='570' height='350'>
      <defs></defs>
      <g transform='scale(0.6333333333333333) translate(0, 55.962634101617674)'>
        <path
        ...
        >
          <image
            ...
            href={
              results['2'].active
                ? tick
                : results['2'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='192.83453603447526'
            y='244.4439809336472'
          ></image>
        </Tooltip>
        <Tooltip
        ...
        >
          <image
            ...
            href={
              results['3'].active
                ? tick
                : results['3'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='155.66505215023633'
            y='267.0575637375135'
          ></image>
        </Tooltip>
        <Tooltip
        ...
        >
          <image
            ...
            href={
              results['9'].active
                ? tick
                : results['9'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='434.12316357508234'
            y='220.74201427574303'
          ></image>
        </Tooltip>
        <Tooltip
          classes={{
        ...
        >
          <image
            ...
            href={
              results['4'].active
                ? tick
                : results['4'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='136.94579478253874'
            y='227.56504337831407'
            cursor='pointer'
          ></image>
        </Tooltip>
        <Tooltip
        ...
        >
          <image
            ...
            href={
              results['19'].active
                ? tick
                : results['19'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='318.73872876463327'
            y='109.32489798534266'
          ></image>
        </Tooltip>
        <Tooltip
          classes={{
        ...
        >
          <image
            ...
            href={
              results['13'].active
                ? tick
                : results['13'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='494.80575608177406'
            y='268.789476619731'
          ></image>
        </Tooltip>
        <Tooltip
        ...
        >
          <image
            ...
            href={
              results['5'].active
                ? tick
                : results['5'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='125.75739193290707'
            y='192.57121541394187'
          ></image>
        </Tooltip>
        <Tooltip
          classes={{
        ...
        >
          <image
            ...
            href={
              results['11'].active
                ? tick
                : results['11'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='443.60487197958327'
            y='141.538580073839'
          ></image>
        </Tooltip>
        <Tooltip
        ...
        >
          <image
            ...
            href={
              results['17'].active
                ? tick
                : results['17'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='253.23192326489573'
            y='140.57852300370843'
          ></image>
        </Tooltip>
        <Tooltip
          classes={{
        ...
        >
          <image
            ...
            href={
              results['8'].active
                ? tick
                : results['8'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='380.99564044056797'
            y='162.43307453549787'
          ></image>
        </Tooltip>
        <Tooltip
          classes={{
        ...
        >
          <image
            ...
            href={
              results['6'].active
                ? tick
                : results['6'].active === false
                ? cross
                : map_pin
            }
            width='15'
            height='15'
            x='142.43013175383143'
            y='130.752604571166'
          ></image>
        </Tooltip>
      </g>
